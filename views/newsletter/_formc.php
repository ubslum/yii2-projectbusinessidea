...
$this->registerCss(".newsletter-form label { display: none; } .btn{ padding: 14px 45px; } .form-control{ height: 38px; padding: 6px 25px; } .newsletter-form .form-group { margin-bottom: 8px; }");
